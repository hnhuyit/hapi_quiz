...
exports.save = {
    ...
    validate: {
        payload: {
            result_status: Joi.string().description('Result Status'),
            start: Joi.date().description('Start'),
            end: Joi.date().description('End'),
            score_obtained: Joi.number().description('Score Obtained'),
            percentage_obtained: Joi.number().description('Percentage Obtained'),
            total_time: Joi.number().description('Total Time'),
